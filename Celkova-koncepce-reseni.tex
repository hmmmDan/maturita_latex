...
\emph{The Exploration} využívá více milosrdnou \emph{soft death}, kdy, pokud hráč spadne nebo se mu nějak jinak povede zemřít, místo toho, aby se scéna načetla od začátku, tak je hráč jen přemístěn   k poslednímu aktivovanému checkpointu. Je možné říct, že tato videohra tak používá hybridní systém smrti.
...
\begin{itemize}
    ...
    \item vinylový efekt
    \item Další inspirace byla převzata například ze skladeb „It’s Just a Burning Memory“ (The Caretaker) \cite{caretaker-burning-memory}, „Moog City 2“ (C418) nebo`' „Resonance“ (Home).
\end{itemize}
