...
\emph{The Exploration} využívá více milosrdnou \emph{soft death}, kdy, pokud hráč spadne nebo se mu nějak jinak povede zemřít, místo toho, aby se scéna načetla od začátku, tak je hráč jen přemístěn   k poslednímu aktivovanému checkpointu. Můžeme říct, že naše videohra tak používá hybridní systém smrti.
...
Pro zpestření herního zážitku naší hry jsem přišel s konceptem \emph{Emotion System}. Hráč bude muset v části \emph{The Exploration} sbírat Conversation~Fragments (části konverzace), které obsahují atributy emocí, a na základě kontextu celé konverzace musí hráč správně určit, jestli má daný   Conversation~Fragment pozitivní, negativní nebo neutrální emoci. Podle toho pak bude potřeba sesbírané Conversation~Fragments správně umístit na „The Altar“ (oltář), který je schopen aktivovat portál do dalšího levelu v případě správné kombinace.
...
Jedna z nejzákladnějších částí UI je Input System, který řeší, jaké hardware vstupy způsobují jakou akci ve videohře. Dvě základní vstupní zařízení, kterými dnešní počítače disponují, jsou klávesnice a myš. Některé videohry používají pouze klávesnici (Hollow Knight od studia Team Cherry \cite{hollow-knight}) a některé zas pouze myš (Happy Game od studia Amanita Design \cite{happy-game}). Častěji se však můžeme setkat s kombinací obou. Dříve jsme ve vývoji naší videohry používali kombinaci obou -- levá ruka obsluhovala veškerý pohyb včetně skákání a dashe (rychlý posun kupředu), zatímco pravá ruka zaujímala pozici na myši, kterou jsme využívali pro míření, střílení a „camera peeking". Postupem času jsme se však rozhodli přejít výhradně na klávesnici, jelikož tato varianta lépe rozloží aktivitu mezi obě ruce a eliminuje potřebu přesunu ruky mezi zařízeními. V budoucnu zvažujeme implementaci více možností ovládání, aby si každý hráč mohl vybrat variantu, která mu nejvíce vyhovuje.
